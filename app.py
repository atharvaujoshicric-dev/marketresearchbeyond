...
st.markdown("""
    <div style='margin-top: -15px; margin-bottom: 10px;'>
        <span style='background-color: #FFFF00; padding: 2px 8px; border-radius: 4px; border: 1px solid #99cc33; font-size: 0.9em; color: black;'>
            <u><strong>NOTE :-</strong> Please cross check the sheet.</u>
        </span>
    </div>
