...
# --- STREAMLIT UI ---
st.set_page_config(page_title="Real Estate Emailer", layout="wide")
...
if uploaded_file:
    ...
    if desc_col and cons_col and prop_col:
        with st.spinner('Processing data...'):
            ...
            user_email = st.text_input("Enter recipient email address:")
            if st.button("Send Email"):
                if user_email:
                    if send_email(user_email, processed_data, "Property_Analysis.xlsx"):
                        st.balloons()
